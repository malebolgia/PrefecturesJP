<div class="box-header with-border">
    <h3 class="box-title"> {{ trans('cms.view') }}   {{ trans('prefectures::prefecture.name') }}  [{{ $prefecture->name }}]  </h3>
...
<div class="box-body" >
    <div class="nav-tabs-custom">
        ...
        <ul class="nav nav-tabs primary">
            <li class="active"><a href="#details" data-toggle="tab">  {{ trans('prefectures::prefecture.name') }}</a></li>
        </ul>
        {!!Former::vertical_open()
        ->id('show-prefectures-prefecture')
        ->method('POST')
        ->files('true')
...
$(document).ready(function(){
    ...
    $('#btn-edit').click(function(){
        $('#entry-prefecture').load('{{URL::to('admin/prefectures/prefecture')}}/{{$prefecture->id}}/edit');
    });
    ...
    $('#btn-delete').click(function(){
        swal({
            ...
            closeOnConfirm: false
                ...
                $.ajax({
                    url: '{{URL::to('admin')}}/prefectures/prefecture/{{$prefecture->id}}',
                    type: 'DELETE',
                    processData: false,
                    contentType: false,
                    success:function(data, textStatus, jqXHR)
                    {
                        swal("Deleted!", "The prefecture has been deleted.", "success");
